...
import com.UdaiCoders.flatstomachworkout.ConstantValues;
import com.UdaiCoders.flatstomachworkout.R;
import com.UdaiCoders.flatstomachworkout.activities.Activity_MyProfile;
...
public class Profile_Fragment extends Fragment {
    ...
    private void setUpView() {
        ...
        this.policy.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String url = "https://freecodeofficial.blogspot.com/";
