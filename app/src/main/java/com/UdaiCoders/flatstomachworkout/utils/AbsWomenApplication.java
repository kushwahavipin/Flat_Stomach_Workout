package com.UdaiCoders.flatstomachworkout.utils;
...
public class AbsWomenApplication extends Application {
    ...
    public  void a() {
        if (this.textToSpeech == null) {
            this.textToSpeech = new TextToSpeech(getInstance(), new com.UdaiCoders.flatstomachworkout.b.b(this));
        }
    }
    ...
    public void addEarCorn() {
        try {
            if (this.textToSpeech != null) {
                this.textToSpeech.addEarcon("tick", "com.freecode.flatstomachworkout", R.raw.clocktick_trim);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onCreate() {
        ...
        new Thread(new com.UdaiCoders.flatstomachworkout.b.a(this)).start();
    }
